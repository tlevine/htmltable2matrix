days="""<form>\r\n<table><tr><td align="center" style="color:#ff0000"><img src="/apps/SSAdmin/views/images/downArrow.gif"></td>\r\n<td style="color:#ff0000; font-size: 14px;">Select Day<br>of Travel</td>\r\n</tr></table><select name="selFrequency" onchange="window.location=\'/coachSS/index.asp?action=RouteReload&amp;order=&amp;sitePageName=%2Fshortline%2Fss.details.asp&amp;dayFilter=\'+this.value;"><option value="">\r\n    \t\t\tShow All\r\n    \t\t</option><option value="">Show All</option><option value="All">Daily</option><option value="Weekdays">Weekdays</option><option value="Mo">Monday</option><option value="Tu">Tuesday</option><option value="We">Wednesday</option><option value="Th">Thursday</option><option value="Fr">Friday</option><option value="Sa">Saturday</option><option value="Su">Sunday</option></select></form>&#13;\n    \t\t&#160;&#13;\n    \t"""

fromstop1="""<table cellspacing="0" cellpadding="0" border="0"><tr><td align="left" valign="top"><!--mp_trans_disable_start--><img src="/apps/ssadmin/actions/RenderStopName_ah.asp?title=Cornell%2C%20North%20Campus%2C%20CC%20Lot" alt="Cornell, North Campus, CC Lot" title="Cornell, North Campus, CC Lot"><!--mp_trans_disable_end--></td>\r\n</tr></table>"""
...
arrow="""<img src="/apps/SSAdmin/views/images/x.gif" width="1" height="1">"""
